...
test_dataset = FacialKeypointsDataset(csv_file='/Users/gautamsharma/Desktop/Python/CVND_Exercises/P1_Facial_Keypoints/data/test_frames_keypoints.csv',
                                      dataset_location='/Users/gautamsharma/Desktop/Python/CVND_Exercises/P1_Facial_Keypoints/data/test',
...
with torch.no_grad():
    ...
    print(first_conv2D_filter.shape)
